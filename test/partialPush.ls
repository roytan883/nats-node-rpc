...
clientA = natsRpc.Create natsServers, "clientA", !->
  ...
  clientA.RegisterPushHandlerPartial "testFn", (topic, msg) !->
...
clientB = natsRpc.Create natsServers, "clientB", !->
  ...
  clientB.RegisterPushHandlerPartial "testFn", (topic, msg) !->
...
clientC = natsRpc.Create natsServers, "clientC", !->
  ...
  clientC.RegisterPushHandlerPartial "testFn", (topic, msg) !->
