 ...
 * Time: 10:48
 */
var natsLib, natsRpc, natsServers, clientA, clientB, clientC, clientHook, clientTest;
...
clientHook = natsRpc.Create(natsServers, "clientHook", function(){
  console.log("[clientHook]-->[init] >>> connected to nats");
  clientHook.RegisterHookRpcHandlerFull("testFn", function(topic, msg){
    console.log("[clientHook]-->[testFn] Hook topic = ", topic);
    console.log("[clientHook]-->[testFn] Hook msg = ", msg);
  });
  clientHook.RegisterHookReplyHandlerFull("testFn", function(topic, msg){
