...
clientA = natsRpc.Create(natsServers, "clientA", function(){
  ...
  clientA.RegisterPushHandlerPartial("testFn", function(topic, msg){
...
clientB = natsRpc.Create(natsServers, "clientB", function(){
  ...
  clientB.RegisterPushHandlerPartial("testFn", function(topic, msg){
...
clientC = natsRpc.Create(natsServers, "clientC", function(){
  ...
  clientC.RegisterPushHandlerPartial("testFn", function(topic, msg){
